  ...
  <div class="mb-32">
    ...
    <div class="grid grid-cols-2 md:grid-cols-4 gap-8 max-w-5xl mx-auto">
      ...
      >
        ...
        <h3 class="font-medium mb-2 text-center text-white group-hover:text-violet-400 transition-colors">{{ tech.name }}</h3>
        <p class="text-sm text-gray-400 text-center group-hover:text-gray-300 transition-colors">{{ tech.description }}</p>
      </div>
    </div>
  </div>
</template>
...
const technologies = [
  ...
  },
  {
    ...
    description: 'Node.js, Express, NestJS, Python, Flask'
  },
  {
